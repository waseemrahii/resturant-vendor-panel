  ...
  return (
    <fieldset className="max-w-4xl mx-auto p-4 bg-white shadow-md border rounded-md w-full lg:w-[80%] md:w-[80%] border-gray-300 px-6 py-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-gray-700 text-[1rem] font-semibold mb-2">First Name</label>
          <input
            type="text"
            defaultValue="Urf"
        ...
        <div>
          <label className="block text-gray-700 text-[1rem] font-semibold mb-2">Last Name</label>
          <input
            type="text"
            defaultValue=""
            className="w-full p-2 bg-[#F5F5F5] border border-gray-300 rounded-md focus:outline-none focus:border-primary-900"
        ...
        <div>
          <label className="block text-gray-700 text-[1rem] font-semibold mb-2">Email</label>
          <input
            type="text"
